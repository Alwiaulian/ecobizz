...
class ColorsCustom {
  ...
  static const Color backgroundAudioPlayer = Color(0xffFFEACC);
  static const Color backgroundAudioClassView = Color(0X4DFEBA57);
  static const Color progressAudio = Color(0xffFF8181);
  ...
  static const Color colorGreen = Color(0xff57D38C);
  static const Color colorGreen400 = Color(0xff41C077);

  // Color Text
  static const Color textGrey = Color(0XFFACB5BD);
  static const Color textWhite = Colors.white;
  static const Color textWhitess = Color(0XFFFFFFFF);
  ...
  static const Color shadowColorBackButton = Color(0X0F000000);

  // Border Color
  static const Color darkGrey30 = Color(0xffACB5BD);

  // Linear Gradient Color
  
  static const LinearGradient linearGradientHomeTop = LinearGradient(
      colors: [Color(0XFFD4ACF8C), Color(0xffF75EDA6)],
      begin: Alignment.centerLeft,
      end: Alignment.centerRight);

  static LinearGradient linearGradientDetailClass = LinearGradient(
    colors: [Colors.black12.withOpacity(0.8), Colors.white10.withOpacity(0.0)],
    stops: [0.35, 1],
    begin: Alignment.bottomCenter,
    end: Alignment.topCenter,
  );

  // Box Type Category Color
  static const Color boxTypeCategory = Color(0XFFF0FBFC);
}
...
class PrimaryColor {
  ...
  Color get green => const Color (0xff57D38C);
  Color get greengradient => const Color (0XB357D38C);
}
...
class OthersColor {
  ...
  Color get blueAqua => const Color(0xffEDF9FA);
  // Yellow
  ...
  // Dark Grey
  Color get darkgrey80 => const Color(0xff373737); 
  Color get darkgrey70 => const Color(0xff525252); 
  Color get darkgrey60 => const Color(0xff858585); 
  ...
  Color get darkGrey300 => const Color(0xffD0D0D0);

  Color get darkgrey800 => const Color(0xff373737); 
  Color get darkGrey900 => const Color(0xff212121);
  Color get darkGrey200 => const Color(0xffE5E5E5);

  Color get darkGrey100 => const Color(0xffF4F3F3);
  ...
  Color get grey600 => const Color(0xff858585);
  Color get greyscale => const Color(0xff9CA3AF);

  

  // Orange
  Color get orange100 => const Color(0xffFFF1D6);
  Color get orange400 => const Color(0xffFFB165);
  ...
  Color get red40 => const Color(0xffE6615F);
  ...
  // Blue
  Color get blue500 => const Color(0xff4F85E9);
  Color get blue50 => const Color(0xffEEF6FF);
  ...
  Color get skyBlue60 => const Color(0xffE8FDFF);
  ...
  Color get skyBlue05 => const Color(0xffE8FEFF);
  ...
  // Green
  Color get green400 => const Color(0xff41C077);
