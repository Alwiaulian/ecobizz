...
class TextFormStyleForgotPassword extends StatelessWidget {
  final String title;
  ...
  const TextFormStyleForgotPassword({
    Key? key,
    required this.title,
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(
                      SizedBorderRadius.borderRadiusSuperSmallxx),
                  borderSide:  BorderSide(color: ColorsCustom.othersColor.whiteGrey50),
                ),
